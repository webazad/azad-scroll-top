...
<fieldset>
    ...
    <p>
        <label>
            ...
            <?php esc_html_e( 'Icon', AST_TEXTDOMAIN ); ?>
        </label>        
        <label>
            ...
            <?php esc_html_e( 'Text', AST_TEXTDOMAIN ); ?>
        </label>        
    </p>    
</fieldset>
<?php }
...
<fieldset class="azad-scroll-top-vertical">
    ...
    <p class="checkbox-img">
        <label for="enable_scroll_top">
            ...
            <img src="<?php echo plugins_url( 'assets/img/rounded.png', dirname( __FILE__ ) ); ?>" alt="<?php esc_attr_e( 'Rounded', AST_TEXTDOMAIN ); ?>" />
        ...
        <label for="enable_scroll_top">
            ...
            <img src="<?php echo plugins_url( 'assets/img/square.png', dirname( __FILE__ ) ); ?>" alt="<?php esc_attr_e( 'Rounded', AST_TEXTDOMAIN ); ?>" />
            <span class="screen-reader-text"><?php esc_html_e( 'Rounded', AST_TEXTDOMAIN ); ?></span>
        </label>
        <label for="enable_scroll_top">
            <input type="radio" name="azad_scroll_top_plugin_settings[azad_scroll_top_radius]"  value="circle" <?php checked( 'circle', $settings ); ?>/>
            <img src="<?php echo plugins_url( 'assets/img/circle.png', dirname( __FILE__ ) ); ?>" alt="<?php esc_attr_e( 'Rounded', AST_TEXTDOMAIN ); ?>" />
            <span class="screen-reader-text"><?php esc_html_e( 'Rounded', AST_TEXTDOMAIN ); ?></span>
        </label>
    </p>    
</fieldset>
...
?>
<fieldset class="azad-scroll-top-vertical">
    <legend class="screen-reader-text"><span><?php esc_html_e( 'Animation', AST_TEXTDOMAIN ); ?></span></legend>
    <p>
        <label for="enable_scroll_top">
